export default {
  "zh": {
    ...
    "保存草稿": "保存草稿",
    "保存草稿后，": "保存草稿后，在【攻略】页点击+号即可继续撰写本篇文章是否确认保存草稿？",
    ...
    "已选神器：0": "已选神器：0",
    "核心/必备英雄": "核心/必备英雄",
    "仅需要上传截图": "仅需要上传截图与较少文字即可发布攻略你后期也可以将快捷攻略转换为详细攻略",
    "保存草稿后，在": "保存草稿后，在【攻略】页点击+号即可继续撰写本篇文章是否确认保存草稿？",
    "第2顺位": "第2顺位",
    ...
    "点击此处输入如": "点击此处输入如  阵容截图/上阵时机/装备截图/神器截图/关键信息/其他信息",
    "发布攻略类型选": "发布攻略类型选择",
    "两件套/左侧装": "两件套/左侧装备",
    ...
    "第3顺位": "第3顺位",
    "时间戳具体时间": "时间戳具体时间范围如  01:06~03:35  等具体时间范围",
    "点击任意空白处关": "点击任意空白处关闭",
    " 返回": " 返回",
    "快捷设置英雄信": "快捷设置英雄信息",
    "第6顺位": "第6顺位",
    ...
    "适合硬核玩家撰": "适合硬核玩家撰写详细攻略内容详细攻略不可以转换为快捷攻略",
    "数据每日00:": "数据每日00:00更新",
  ...
  "fr": {
    ...
    "提示": "Tipp",
    "正在大批量取": "Du bist dabei, Lesezeichen in großen Mengen zu löschen. Bist dudir sicher?",
    ...
    "请先发布引用": "Bitte veröffentliche deinen zitierten Content, bevor du mit dem Zitierenfortfährst.",
    ...
    "暂未发布任何": "Kein Content wurde bis jetzt veröffentlich. Klicke den unteren Buttonzum Veröffentlichen.",
    "立即前往": "Aller maintenant",
    "暂不支持更换": "Diese Funktion wird noch nicht unterstützt. Bitte warte auf zukünftigeUpdates.",
    "已发布": "Publié",
    "已下架": "Supprimé",
    "上架": "Publier",
    "下架": "Dépublier ",
    ...
    "快捷攻略发布": "Guide rapide",
    "仅需要上传截": "Du musst nur Screenshots und ein paar Worte hochladen, um einen Leitfadenzu veröffentlichen. ",
    "你后期也可以": "Du kannst eine Kurzanleitung später in einen ausführlichenLeitfaden umwandeln.",
    ...
    "描述你的通关": "Beschreibe deine Stufenabschlussdetails, um Spielern zu helfen, dein TeamSetup besser zu verstehen.",
    ...
    "发布": "Veröffentlichen",
    "点击英雄后，": "Klicke auf den Helden, um ihn mit einem anderen Helden zu ersetzen oderden Platz frei zu lassen.",
    ...
    "这里是核心通": "Hier ist der Haupt-Stufenabschlussleitfaden, er kann nicht länger als500 Wörter sein, klicke hier, um mit dem Schreiben zu beginnen.",
